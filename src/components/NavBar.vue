<template>
  ...
  <img src="../assets/image/logowhitetransparant.png" class="w-42" alt="Logo" />
    ...
    <!-- Navbar Link-->
    <nav
    :class="['fixed inset-0 z-20 flex flex-col items-center justify-center bg-[#111827] md:relative md:bg-transparent md:flex md:justify-between md:flex-row pb-9', 
