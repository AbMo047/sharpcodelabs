  ...
  <section class="text-[#5a422e] mt-20" id="projects">
    <div class="px-4 xl:pl-16">
      ...
      <div class="mb-4 md:flex md:justify-between xl:pr-16">
        <h2 class="text-4xl font-bold text-[#5a422e]">
          {{ $t("latestProjects") }}
        </h2>
      ...
      >
        <div v-for="project in filteredProjects" :key="project.id">
          ...
          >
            <div
              class="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-70 transition-all duration-500"
            >
              <a
              ...
              >
                ...
                >
                  <path
                    ...
                    d="M17.25 6.75L22.5 12l-5.25 5.25M6.75 6.75L1.5 12l5.25 5.25"
                  />
                </svg>
              </a>
              <a
          ...
          <!-- Project details -->
          <div
            class="text-[#5a422e] rounded-b-xl mt-3 bg-[#fdf7ef] shadow-lg border border-[#ecdcc3] py-6 px-4"
          >
